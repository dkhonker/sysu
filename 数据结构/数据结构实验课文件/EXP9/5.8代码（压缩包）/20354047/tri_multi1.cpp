...
//a is the first matrix and b is the second matrix and Q is the trimatrix after multiplied and q is the real matrix after multiplied.
void tri_multi() 
{
	...
	Q[0][1] = b[0][1];
	Q[0][2] = 0;
	for (int m= 0; m <Q[0][0]; m++)
	{
		for (int n = 0; n < Q[0][1]; n++)
		{
			q[m][n]=0;
		}
	}
