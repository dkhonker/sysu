...
void buildTree(){
  ...
  for (int i = 2; i <= n; i++){
	...
	if (lastchild[f] == 0)
		...
		nodes[lastchild[f]].rchild=i;lastchild[f]=i;//Fill this part by yourself.  Think about it first.
	}
  }
}
...
cout<<root.data;
Midorder(nodes[root.rchild]);//please finish the following parts. It is easier. 
}
